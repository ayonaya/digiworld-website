...
// This array holds all product data, including names, prices, images,
// delivery information, and new promotional details like discount percentages
// and quantities sold.
// Each product object is structured to support multiple languages and currencies.
const products = [
  {
    id: "office365lifetime",
    category: "Office",
    isHot: true, // Indicates if the product is a "hot" item for special display
    discountPercentage: 20, // Percentage discount for promotional pricing
    soldQuantity: 120, // Number of units sold, for social proof/urgency
    name: {
    ...
    desc: {
      en: "1 Year subscription for up to 5 devices. Full Microsoft Office 365 suite including Word, Excel, PowerPoint and more. Instant delivery to your email after payment."
    },
    features: {
      en: [
        "1-Year subscription for full access with 100GB cloud.",
        "Install on up to 5 devices (PC, Mac, tablets, and phones).",
        "Includes the latest versions of Word, Excel, PowerPoint, Outlook, and OneNote.",
        "Comes with 100GB of secure OneDrive cloud storage.",
        "Guaranteed genuine account with instant email delivery."
      ]
    },
    requirements: {
      en: [
        "Operating System: Windows 10/11, or the three most recent versions of macOS.",
    ...
    activation: {
      en: [
        "After purchase, you will receive an email with your new Office 365 account details.",
        "Go to the official site: portal.office.com",
        "Sign in with the provided username and password.",
        "You will be prompted to change the password on first login.",
        "Download and install the Office suite directly from your account dashboard."
      ]
    }
  },
  {
    ...
    features: {
      en: [
        "Genuine Microsoft Windows 10 Pro activation key.",
        "Lifetime license for one PC.",
        "Supports both 32-bit and 64-bit versions.",
        "Unlocks all professional features including BitLocker and Remote Desktop.",
        "Global key - can be used and activated anywhere in the world."
      ]
    },
    requirements: {
      en: [
    ...
    activation: {
      en: [
        "Ensure your version of Windows is Windows 10 Pro.",
        "Go to 'Settings' > 'Update & Security' > 'Activation'.",
        "Click on 'Change product key'.",
        "Enter the 25-digit key you received via email.",
        "Click 'Next' to activate your genuine copy of Windows."
      ]
    }
  },
  {
    ...
    features: {
      en: [
        "Genuine Microsoft Windows 11 Pro activation key.",
        "Lifetime license for one PC.",
        "Experience the new modern interface and features.",
        "Includes advanced security features like hardware-based isolation.",
        "Global key - can be used and activated anywhere in the world."
      ]
    },
    requirements: {
    ...
    activation: {
      en: [
        "Ensure your version of Windows is Windows 11 Pro.",
  ...
  },
  {
    ...
    features: {
      en: [
        ...
        "Licensed for home and commercial use on one PC.",
        "Includes Publisher and Access (PC only).",
    ...
    activation: {
      en: [
        "Uninstall any previous version of Office.",
        "Download and install Office 2021 Pro Plus from the official link provided in your email.",
        "Open any Office application (e.g., Word).",
        "Enter the 25-digit product key when prompted.",
  ...
  },
  {
    ...
    features: {
      en: [
        "Get the very latest Office applications with this one-time purchase.",
        "Includes the 2024 versions of all classic Office apps.",
        "Licensed for home and commercial use on one Windows PC.",
        "Enhanced features and performance improvements over previous versions.",
        "Instant digital delivery."
      ]
    },
    requirements: {
    ...
    activation: {
      en: [
        "Ensure no other version of Office is installed.",
        "Use the official download link provided in your delivery email.",
        "Run the installer and wait for it to complete.",
        "Open an Office app like Word and enter your product key to activate.",
        "Enjoy the latest version of Office!"
      ]
    }
  },
  {
    ...
    features: {
      en: [
        "Genuine license for Microsoft Project Professional 2021.",
        "Powerful project management tools and templates.",
        "Manage schedules, resources, and finances.",
    ...
    activation: {
      en: [
        "Download and install Project Professional 2021 from the official link.",
        "Open Microsoft Project.",
        "Enter the 25-digit product key you received via email.",
  ...
  },
  {
    ...
    features: {
      en: [
        "Genuine license for Microsoft Visio Professional 2021.",
        "Create professional diagrams, flowcharts, and floor plans.",
        "Comes with a rich library of modern shapes and templates.",
        "One-time purchase for one PC.",
        "Instant digital delivery."
      ]
    },
    ...
    activation: {
      en: [
        "Download and install Visio Professional 2021 from the official link.",
...
// Export the products array so it can be imported by other scripts
export { products };