const products = [
  {
    ...
    isHot: false,
    name: {
      // UPDATED: Changed "Lifetime" to "1 Year"
      en: "Office 365 Account - 1 Year Subscription (5 Devices)",
      // ... other languages
    },
    ...
    desc: {
      // UPDATED: Changed description to reflect 1-year term
