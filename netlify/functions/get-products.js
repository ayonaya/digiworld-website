...
// This is the single, authoritative source for product data.
// By placing the array directly in this file, we ensure it's always
// available when the function is deployed, fixing the 502 error.
const products = [
  {
